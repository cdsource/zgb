...
* @version 创建时间：2017年10月22日 下午5:21:30 
* 类说明 
*/ 
...
import com.asiainfo.utils.excelutils.WriteExcel;
...
public class ReadTitle {
    ...
    public static  boolean  readTitleFromCSV( String strCvsFileName) {
        ...
        try {
            ...
            // 打开CSV文件
            bufferedReader =
                    new BufferedReader(new InputStreamReader(new FileInputStream(strCvsFileName),
            ...
            TaoBaoUtils.writeToCsv(strCvsFileName, vCSV);
