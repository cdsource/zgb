...
public class ImproveGoods {
        ...
        try {
            ...
            while ((nextLine = csvReader.readNext()) != null) {
                ...
                if (iRow >= 3) {
                    ...
                    nextLine[20] = addDescBegin(strDescPicPath) + RandomUtil.getRandomDescPicOrder(nextLine[20])
            ...
            TaoBaoUtils.appendCsv("zgb_goods.csv", AiDateTimeUtil.getCurrDate() + "\t" + strCvsName + "\t"
    ...
    private  String addDescCode(String strCode) {
        return "<p><span style=\"color:#ffffff;\">" + RandomUtil.getShopCode(strCode).replaceAll("\"", "")
                + "</span></p>";
    }
     ...
     */
    public void selectPicDesc2Main(MainPicInfo cMainPicInfo, String strCvsName, final String strPicOrder)
            throws Exception {
        ...
        for (int i = 0; i < cMainPicInfo.v_MainPic.size(); i++) {
            ...
            AiFileUtil.copyFile(strDescPicPath + "\\" + strNewFileName + ".tbi", cMainPicInfo.v_MainPic.get(i));
        ...
        for (int i = 0; i < cMainPicInfo.v_LastMainPic.size(); i++) {
            ...
            cMainPicInfo.v_LastMainPic.set(i, cMainPicInfo.v_LastMainPic.get(i).substring(strDescPicPath.length() + 1,
                    cMainPicInfo.v_LastMainPic.get(i).length() - 4));
            logger.debug(cMainPicInfo.v_LastMainPic.get(i));
        }
    ...
    public String getNewMainPicOrder(String strPicOrder, MainPicInfo cMainPicInfo) throws Exception {
        try {
            ...
            if (iPos > 0) {
                ...
                // 多取一个，用着没有白底图的替补
                String[] strOders = RandomUtil.getRandomInt(cMainPicInfo.v_MainPic.size(), iMaxLength).split(",");
                ...
                if (cMainPicInfo.v_LastMainPic.size() > 0) {
                    ...
                    sb.append(cMainPicInfo.v_LastMainPic.get(iLastMainPic) + ":1:" + (iMaxLength - 1) + ":|;");
                } else {
